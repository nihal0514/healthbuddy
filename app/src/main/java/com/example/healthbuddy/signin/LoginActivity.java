...
public class LoginActivity extends AppCompatActivity {
  //  private Button LoginButton;
    ...
    private TextView NeedNewAccountLink,doctorlogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_ui_demo);
    ...
    private void sendusertoDoctorRegister() {
        Intent intent=new Intent(LoginActivity.this,DoctorRegister.class);
